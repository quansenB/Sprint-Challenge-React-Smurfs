...
client side occurs only in the frontend, the displayed page is modified based on the Url but the client already has the infos needed for the change, contrary to in client side routing, weher the client would need to reuest the new information
